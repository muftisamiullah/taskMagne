...
<span class="container">
    <img class="responsive" src="imgs/img4.jpg" style="margin-left:-15px;">
            ...
            <div class="forming">
                ...
                Please complete the form below and we will be in touch shortly.</strong></h5>
                     <form>
                        ...
                        <button type="submit" class="btn btn-primary float-right">Send</button><br>
                    </form><br>
        </div>
        <div class="col-sm-6">
...
<div style="background:#D3D3D3;"><br><br>
    <h3 style="padding-left:100px;">Q Advertising Head Office</h3>
